...
const Contact = () => {
  ...
  return (
    ...
    <form action='https://getform.io/f/fff685ec-a824-4f7c-8cc8-fb8f909f2524' method='POST' className='flex flex-col max-w-[600px] w-full '>
      <div className='pb-8'>
      <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300 '>
      Contact
      </p>
      <p className='text-gray-300 py-4'>//Submut the form below to contact with me or shoot me a mail using the link in the home</p>
      </div>
      ...
      <input type="text" name="link" placeholder='Enter your resume link' className='bg-[#ccd6f6] p-2 my-4'/>
